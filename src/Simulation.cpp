...
Simulation::Simulation(char const* const configFileName) {
	...
	cpu->Init(set.pdb, set.config.out, set.config.sys.step.equil, totalSteps);
...
void Simulation::RunningCheck(const uint step) {
	...
	std::cout
			...
			<< std::endl << "System: " << std::setw(12)
			<< system->potential.totalEnergy.intraBond << " | " << std::setw(12)
			<< system->potential.totalEnergy.intraNonbond << " | "
			...
			<< pot.totalEnergy.tc << std::endl << "-------------------------"
			<< std::endl << "Virial            INTER |           TC"
			<< std::endl << "System: " << std::setw(15)
			<< system->potential.totalVirial.inter << " | " << std::setw(12)
			<< system->potential.totalVirial.tc << std::endl << "Recalc: "
			<< std::setw(15) << pot.totalVirial.inter << " | " << std::setw(12)
			<< pot.totalVirial.tc << std::endl << "-------------------------"
			<< std::endl
			<< "================================================================"
			<< std::endl << std::endl;
