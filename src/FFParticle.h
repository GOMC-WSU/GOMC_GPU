...
public:
	...
	void Init(ff_setup::Particle const& mie, ff_setup::NBfix const& nbfix,
...
// protected:
	...
	double * sigmaSq, *epsilon_cn, *epsilon_cn_6, *nOver6, *sigmaSq_1_4,
			*epsilon_cn_1_4, *epsilon_cn_6_1_4, *nOver6_1_4, *enCorrection,
			*virCorrection, *shiftConst, *An, *Bn, *Cn, *sig6, *sign,
...
//mie potential
inline void FFParticle::Calc(double & en, double & vir, const double distSq,
		const uint index,
#ifdef MIE_INT_ONLY
		const uint n,
#else
