...
std::map<std::string, ReadableBaseWithFirst *> FFSetup::SetReadFunctions(
		const bool isCHARMM) {
...
void Particle::Add(double e, double s, const uint expN, double e_1_4,
		double s_1_4, const uint expN_1_4) {
	if (isCHARMM) {
		e *= -1.0;
		s *= RIJ_OVER_2_TO_SIG;
		e_1_4 *= -1.0;
